...
-- This library file lists all the standard runtime messages listed in the
-- manual, for easy modification.
...
-- These messages are automatically translated into German or Swedish in your
-- game if you define in the beginning of your source code
--
--    OPTIONS
--      LANGUAGE German.
--
...
--      LANGUAGE Swedish.
--
-- Only the exact equivalents of the above phrases will then be shown; if you
-- change the above English messages to your own wordings, the translations will
-- still be only for the default.
--
--
-- If you wish to write your game in some other language, you must manually
-- translate the messages above. There might be support for more languages in
